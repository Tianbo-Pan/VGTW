...
def activate_grad(modules):
    """
    Activate gradient computation for the parameters of the specified modules.
    
    Args:
        modules (list): List of modules whose parameters should have requires_grad=True.
    """
    for module in modules:
        try:
            for n, param in module.named_parameters():
